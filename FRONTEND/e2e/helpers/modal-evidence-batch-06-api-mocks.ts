...
/** Projeto usado nos lotes 05–06 (FollowUpModal, MemberModal). */
...
/**
 * API mock para `modal-evidence-batch-06.spec.ts` — incidentes, KB, LDAP, membro equipa (modais 26–30).
 * Inclui o mesmo núcleo do lote 05 (dashboard, projetos, referências, etc.).
 */
export async function installModalEvidenceBatch06ApiMocks(page: Page): Promise<void> {
