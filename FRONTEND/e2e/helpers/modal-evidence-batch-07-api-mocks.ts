...
/**
 * API mock para `modal-evidence-batch-07.spec.ts` — atas, notificações, condição comercial, projeto, tarefa (modais 31–35).
 * Baseado no lote 06 + rotas de projeto (minutes, proposals, project-tasks) e notificações/stream.
 */
export async function installModalEvidenceBatch07ApiMocks(page: Page): Promise<void> {
