...
| CTR-02 | Produto | **Histórico de aditivos:** exibir **rastreabilidade** do que cada aditivo alterou (campos antes/depois, valores, datas, anexos), não só “incremento” sem contexto. | [x] | [ ] |
...
| GMUD-02 | Produto | **Pós-conclusão:** após GMUD **finalizada** (sucesso ou falha), **bloquear edição** (somente leitura + auditoria). | [x] | [ ] |
